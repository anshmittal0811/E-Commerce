...
/**
 * OpenAPI/Swagger configuration for the Payment Service API.
 * 
        ...
        return new OpenAPI()
            .info(new Info()
                ...
                .description("Payment Processing Service for E-Commerce Platform. " +
                    "Handles payment creation, processing, PayPal integration, and payment notifications via Kafka.")
                .version("1.0.0")
                .contact(new Contact()
            ...
            .servers(List.of(
                ...
                new Server()
                    .url("http://gateway-service-api:8090/api/payment")
